...
public class GenericUtility {
	...
	public void CheckINOUTDateProvider(WebDriver driver,String ChecinMonthYear, String CheckInDate, String CheckoutMonthYear, String CheckoutDate)
		...
		WebElement ele=driver.findElement(By.xpath("//div[@class='rdrMonthName' and (text()='" + ChecinMonthYear
				+ "')]/following-sibling::div[@class='rdrDays']//span[(text()='" + CheckInDate + "')]//ancestor::button[not(contains(@tabindex,'-1'))]"));
		wait.until(ExpectedConditions.visibilityOf(ele));			
			ele.click();			
		Thread.sleep(1000);
		WebElement Cdt = driver.findElement((By.xpath(
				"//div[@class='rdrMonthName' and (text()='"+CheckoutMonthYear+"')]//following-sibling::div[@class='rdrDays']"
						+ "//span[(text()='"+CheckoutDate+"')]//ancestor::button[not(contains(@tabindex,'-1'))]")));
